                    ...
                    <div class="rounded border p-10">
                        ...
                        <div id="kt_account_settings_profile_details" class="collapse show">
                            ...
                            <form id="kt_account_profile_details_form" class="form"
                                action="{{ Route('admin-updatecms', ['id' => $model[0]->cms_id]) }}">
                                <input type="hidden" name='c_id' value="{{ $model[0]->cms_id }}">
                                <!--begin::Card body-->
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" name="slug"
                                            ...
                                            value="{{ old('slug') != '' ? old('slug') : $model[0]->slug }}" disabled />
                                        <!--end::Input-->
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" name="page_name"
                                            ...
                                            value="{{ old('page_name') != '' ? old('page_name') : $model[0]->page_name }}" />
                                        <!--end::Input-->
                                        <span class="help-block"></span>
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="fv-row mb-7">
                                        <!--begin::Label-->
                                        <label class="required fw-bold fs-6 mb-2">Content Name</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" name="content_name"
                                            class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Content Name"
                                            value="{{ old('content_name') != '' ? old('content_name') : $model[0]->content_name }}" />
                                        <!--end::Input-->
                                        <span class="help-block"></span>
                                    </div>
                                    <!--end::Input group-->
                                    @if ($model[0]->type == '2')
                                        ...
                                        <div class="mb-7">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                @php
                                                    if ($model[0]->content_body != '') {
                                                        $image = URL::asset('public/uploads/frontend/cms/pictures/original/' . $model[0]->content_body);
                                                    } else {
                                                ...
                                                <div class="image-input image-input-outline" data-kt-image-input="true"
                                                    ...
                                                    <label
                                                        ...
                                                        <!--begin::Inputs-->
                                                        <input type="file" name="content_body"
                                                            accept=".png, .jpg, .jpeg" />
                                        ...
                                        @foreach ($model as $language)
                                            <div class="accordion-item">
                                                <h2 class="accordion-header"
                                                    id="kt_accordion_1_header_{{ $loop->iteration }}">
                                                    <button
                                                ...
                                                <div id="kt_accordion_1_body_{{ $loop->iteration }}"
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            <!--begin::Label-->
                                                            <label class="required fw-bold fs-6 mb-2">Content
                                                                ({{ $language->lang_code }})
                                                            </label>
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <textarea class="form-control editor" id="editer{{ $loop->iteration }}" name="{{ $language->lang_code }}"
                                                                placeholder="Content">{{ old('content_body') != '' ? old('content_body') : $language->content_body }}</textarea>
                                                            <!--end::Input-->
                                                            <span class="help-block"></span>
                                                        </div>
                                                        <!--end::Input group-->
