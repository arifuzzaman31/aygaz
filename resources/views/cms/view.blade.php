                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <img class="img-responsive" style="width:200px; height:auto;" src="{{ URL::asset('storage/uploads/admin/cms/pictures/preview/' . $model->content_body) }}" alt="{{ $model->content_body }}">
                            </div>
                            @elseif ($model->type == '3')
