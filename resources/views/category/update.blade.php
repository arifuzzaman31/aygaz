        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <!--begin::Form-->
                    <form id="kt_account_profile_details_form" class="form" action="{{route('admin-updatecategory')}}">
                                ...
                                <div id="kt_accordion_1_body_{{$loop->iteration}}" class="accordion-collapse collapse {{$loop->iteration===1?'show':''}}" aria-labelledby="kt_accordion_1_header_{{$loop->iteration}}" data-bs-parent="#kt_accordion_1">
                                    <div class="accordion-body">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="{{$language->lang_code}}" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Category name" value="{{$language->name}}" />
                                            <!--end::Input-->
                            ...
                            <div class="mb-7">
                                ...
                                <div class="d-flex fv-row">
                                    ...
                                    <div class="form-check form-check-custom form-check-solid">
                                        <!--begin::Input-->
                                        <input class="form-check-input me-3" name="category_status" type="radio" value="1" id="kt_modal_update_status_option_0" {{($language->status=="1")?"checked":""}} />
                                        <!--end::Input-->
                                        <!--begin::Label-->
                                ...
                                <div class="d-flex fv-row">
                                    ...
                                    <div class="form-check form-check-custom form-check-solid">
                                        <!--begin::Input-->
                                        <input class="form-check-input me-3" name="category_status" type="radio" value="0" id="kt_modal_update_status_option_1" {{($language->status=="0")?"checked":""}}/>
                                        <!--end::Input-->
                                        <!--begin::Label-->
