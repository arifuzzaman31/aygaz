                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="rounded border p-10">
                        ...
                        <div id="" class="collapse show">
                            <!--begin::Form-->
                            <form class="form" action="{{ Route('admin-updateBlog') }}" method="post"
                                enctype="multipart/form-data">
                                <input type="hidden" name='parent_id' value="{{ $blog[0]->parent_id }}">
                                <!--begin::Card body-->
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <select name="category_id" id="" required
                                            ...
                                            @foreach ($category as $cat)
                                                <option value="{{ $cat->id }}"
                                                    @if ($cat->id == $blog[0]->category_id) selected @endif>{{ $cat->name }}
                                                </option>
                                            @endforeach
                                    ...
                                    {{-- <div class="fv-row mb-7">
                                        ...
                                        <input type="text" name="slug"
                                            ...
                                            value="{{ old('slug') != '' ? old('slug') : $blog[0]->slug }}" disabled />
                                        <!--end::Input-->
                                        <span class="help-block"></span>
                                    </div> --}}
                                    <!--end::Input group-->
                                    ...
                                    {{-- <div class="fv-row mb-7">
                                        ...
                                        <input type="text" name="page_name"
                                            ...
                                            value="{{ old('page_name') != '' ? old('page_name') : $blog[0]->page_name }}" />
                                        <!--end::Input-->
                                        <span class="help-block"></span>
                                    </div> --}}
                                    {{-- {{ var_dump($blog[1]) }} --}}
                                    ...
                                    <div class="mb-7">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            @php
                                                if ($blog[0]->image != '') {
                                                    $image = URL::asset('public/uploads/frontend/cms/pictures/original/' . $blog[0]->image);
                                                } else {
