        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Cylinder List</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Cylinder</li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-300 w-5px h-2px"></span>
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Cylinder List</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card">
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header" id="kt_modal_add_category_header">
                                            <!--begin::Modal title-->
                                            <h2 class="fw-bolder" id="add-cylinder">Add Cylinder</h2>
                                            <!--end::Modal title-->
                                            <!--begin::Close-->
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            <!--begin::Form-->
                                            <form id="cylinderForm" class="form"
                                                action="{{ route('admin-addcylinder') }}" method="post"
                                                ...
                                                @endforeach --}}
                                                    ...
                                                    <div class="mb-7">
                                                        ...
                                                        <div class="col-lg-8 fv-row">
                                                            ...
                                                            <div class="image-input image-input-outline"
                                                                ...
                                                                style="background-image: url('{{ URL::asset('public/backend/assets/media/avatars/blank.png') }}')">
                                                    ...
                                                    <div class="mb-7">
                                                        <!--begin::Label-->
                                                        <label class="required fw-bold fs-6 mb-5">Weight (KG)</label>
                                                        <!--end::Label-->
                                                        <!--begin::Roles-->
                                                        <!--begin::Input row-->
                                                        <div class="d-flex fv-row">
                                                            ...
                                                            <div class="form-check form-check-custom form-check-solid">
                                                                <!--begin::Input-->
                                                                {{-- <input class="form-check-input" name="category_status" type="text" value="1" id=""  /> --}}
                                                                <input type="number"
                                                                    class="form-control form-control-solid" id="weight"
                                                    ...
                                                    <div class="mb-7">
                                                        <!--begin::Label-->
                                                        <label class="required fw-bold fs-6 mb-5">Price</label>
                                                        <!--end::Label-->
                                                        <!--begin::Roles-->
                                                        <!--begin::Input row-->
                                                        <div class="d-flex fv-row">
                                                    ...
                                                    <div class="mb-7">
                                                        ...
                                                        <div class="d-flex fv-row">
                                                            ...
                                                            <div class="form-check form-check-custom form-check-solid">
                                                                ...
                                                                <input class="form-check-input me-3"
                                                                    name="cylinder_status" type="radio" value="1"
                                                                    id="cylinder_active" checked='checked' />
                                                                <!--end::Input-->
                                                                <!--begin::Label-->
                                                                <label class="form-check-label"
                                                                    for="kt_modal_update_status_option_0">
                                                                    <div class="fw-bolder text-gray-800">Active</div>
                                                                </label>
                                                                <!--end::Label-->
                                                            </div>
                                                        ...
                                                        <div class="d-flex fv-row">
                                                            ...
                                                            <div class="form-check form-check-custom form-check-solid">
                                                                <!--begin::Input-->
                                                                <input class="form-check-input me-3"
                                                                    name="cylinder_status" type="radio" value="0"
                                                                    id="cylinder_deactive" />
                                                                <!--end::Input-->
                                                                <!--begin::Label-->
                                                                <label class="form-check-label"
                                                ...
                                                <div class="text-center pt-15">
                                                    <input type="hidden" id="cylinder_id" name="id">
                                                    <button type="reset" class="btn btn-light me-3"
                                                        data-bs-dismiss="modal" aria-label="Close">Discard</button>
                                                    <button type="submit" class="btn btn-primary"
                                                        data-kt-categorys-modal="submit">
                    ...
                    <div class="card-body py-4">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="">
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                {{-- {{ $cylinder_list }} --}}
                                @foreach ($cylinder_list as $key => $list)
                                    <tr>
                                        <td></td>
                                        <td>{{ $key + 1 }}</td>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-outline-primary" data-bs-toggle="modal"
                                                data-bs-target="#kt_modal_add_category"
                                                onclick="dataEdit({{ $list->id }}, {{ $list->weight }}, {{ $list->price }}, {{ $list->status }}, '{{ $list->image }}');">Edit</button>
                                            <a href="{{ route('admin-deletecylinder') }}?id={{ base64_encode($list->id) }}"
                    ...
                    <script>
                        function dataEdit(id, weight, price, status, image) {
                            // alert(image);
                            $('#weight').val(weight)
                            $('#price').val(price)
                            // $('#clndr_img').val(price)
                            $("#clndr_img").css("background-image",
                                "url({{ URL::asset('public/uploads/frontend/images/') }}/" + image + "");

                            $('#cylinder_id').val(id)
                            $('#add-cylinder').text('Update Cylinder Details')
                            if (status == '1') {
                                // $('#status').val(id)
                                $('#cylinder_active').attr('checked', true)
                            } else {
                                $('#cylinder_deactive').attr('checked', true)
                            }

                            $('#cylinderForm').attr('action', '{{ route('admin-updatecylinder') }}');
                        }
                    </script>
