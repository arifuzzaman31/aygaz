                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="rounded border p-10">
                        ...
                        <div id="" class="collapse show">
                            <!--begin::Form-->
                            <form class="form" action="{{ Route('admin-updateMulti', $cms[0]->parent_id) }}"
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    {{-- <div class="fv-row mb-7">
                                        ...
                                        <input type="text" name="slug"
                                            ...
                                            value="{{ old('slug') != '' ? old('slug') : $cms[0]->slug }}" disabled />
                                        <!--end::Input-->
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--begin::Input-->
                                        <div>
                                            <input type="color" id="head" name="bg_color"
                                                value="{{ $cms[0]->bg_color }}">
                                    ...
                                    <div class="mb-7">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            @php
                                                if ($cms[0]->image != '') {
                                                    $image = URL::asset('public/uploads/frontend/cms/pictures/original/' . $cms[0]->image);
                                                } else {
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="kt_accordion_1_header_{{ $loop->iteration }}">
                                                <button
                                                    ...
                                                    {{ ucfirst($language->language_code) . ' (' . $language->language_code . ')' }}
                                                </button>
                                            </h2>
                                            <div id="kt_accordion_1_body_{{ $loop->iteration }}"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                        <input type="text" name="{{ $language->language_code }}title"
                                                            class="form-control form-control-solid mb-3 mb-lg-0"
                                                            placeholder="Title" value="{{ $language->title }}" />
                                                        <!--end::Input-->
                                                        <span class="help-block"></span>
                                                    </div>
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                        <textarea class="form-control editor" id="editer{{ $loop->iteration }}" name="{{ $language->language_code }}"
                                                            placeholder="Content">{{ old('description') != '' ? old('description') : $language->description }}</textarea>
                                                        <!--end::Input-->
                                                        <span class="help-block"></span>
                                                    </div>
                                                    <!--end::Input group-->
