    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Hire Fixer</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="{{route('admin-hire-request')}}" class="text-muted text-hover-primary">Hire Fixer</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Hire Fixer edit</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="card-header border-0 " >
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bolder m-0">Update hire fixer request</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <!--begin::Input group-->
                             <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select name="currency" class="form-control form-control-solid mb-3 mb-lg-0">
                                    <option value="Dkk" {{ ($model->currency == 'Dkk') ? 'selected' : '' }}>Dkk</option>
                                    <option value="Euro" {{ ($model->currency == 'Euro') ? 'selected' : '' }}>Euro</option>
                                    <option value="Usd" {{ ($model->currency == 'Usd') ? 'selected' : '' }}>Usd</option>
                                    <option value="BTC" {{ ($model->currency == 'BTC') ? 'selected' : '' }}>BTC</option>
                                </select>
                                <!--end::Input-->
                                <span class="help-block"></span>
                            </div>
                                ...
                                <div class="col-md-8">
                                    <div class="radio-list">
                                        <label class="radio-inline">
                                            <input type="radio" name="status" value="1" {{ ($model->status == '1') ? 'checked' : '' }}> Unposted
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="status" value="4" {{ ($model->status == '4') ? 'checked' : '' }}> Done
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="status" value="2" {{ ($model->status == '2') ? 'checked' : '' }}> Posted
                                        </label>
                                    </div>
                                </div>
...
@stop
@section('js')
{{-- <script src="{{ URL::asset('public/backend/assets/js/custom/apps/hire_fixer/edit.js')}}"></script> --}}
...
<script>
  ...
  var csrf_token = $('meta[name=csrf-token]').attr('content');
  var r_file_name = $("#image_" + id).val();
window.location.href = full_path+"public/uploads/admin/request_image/original/"+r_file_name;
}
    ...
    Dropzone.options.myDropzone = {
        init: function () {
            ...
            if (a == 0) {
                $.ajax({
                    type: 'GET',
                    url: full_path + 'show-hire-fixer-images',
                    dataType: 'json',
