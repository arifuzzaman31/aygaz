        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="row g-5 g-xl-8">
                <div class="col-xl-3">
                    ...
                    <a href="admin-cylinder" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                            ...
                            <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5" id="total-count">{{$TotalCylinders}}</div>
                            <div class="fw-bold text-gray-100">Total Cylender Gas</div>
                        </div>
                        <!--end::Body-->
                    </a>
                ...
                <div class="col-xl-3">
                    <!--begin::Statistics Widget 5-->
                    <a href="admin-orders" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{ $Totalorders}}</div>
                            <div class="fw-bold text-white">Total Orders</div>
                            <!--<div class="text-white fw-bolder fs-2 mb-2 mt-5">Budget : ${{$private_tenders_solved_amount->budget}}</div>-->
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                {{-- <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{count($outstanding_private_tenders)}}</div>
                            <div class="fw-bold text-white">outstanding private tenders</div>
                            <!--<div class="text-white fw-bolder fs-2 mb-2 mt-5">Budget : ${{$outstanding_private_tenders_amount->budget}}</div>-->
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
...
@stop
@section('js')
<script src="{{ URL::asset('public/backend/assets/js/custom/chart.js')}}"></script>
<script>
    requestedForword();
    tenderPosted();
    ...
    function handleResetForm(){
        ...
        resetButton.addEventListener('click', function () {
            // Reset payment type
            filterPayment[0].checked = false;
            filterPayment[1].checked = false;
    ...
    function handleFilterDatatable(){
        ...
        filterButton.addEventListener('click', function () {
            ...
            let datepicker=$("#kt_ecommerce_report_views_daterangepicker").val();
            data=new FormData();
            data.append("type",paymentValue);
    ...
    function ajaxCall(data)
    {
        ...
        $.ajax({
            url: full_path+"get-dashboard-request",
