        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Autogas List</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Autogas</li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-300 w-5px h-2px"></span>
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Autogas List</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card">
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header" id="kt_modal_add_category_header">
                                            <!--begin::Modal title-->
                                            <h2 class="fw-bolder" id="add-autogas">Add autogas</h2>
                                            <!--end::Modal title-->
                                            <!--begin::Close-->
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            <!--begin::Form-->
                                            <form id="autogasForm" class="form"
                                                action="{{ route('admin-addautogas') }}" method="post"
                                                ...
                                                @endforeach --}}
                                                        ...
                                                        <div class="d-flex fv-row">
                                                            ...
                                                            <div class="form-check form-check-custom form-check-solid">
                                                                ...
                                                                <input type="number"
                                                                    ...
                                                                    value="1" name="weight" required readonly>
                                                                <!--end::Input-->
                                                                <!--begin::Label-->
                                                    ...
                                                    <div class="mb-7">
                                                        ...
                                                        <div class="d-flex fv-row">
                                                            ...
                                                            <div class="form-check form-check-custom form-check-solid">
                                                                <!--begin::Input-->
                                                                <input class="form-check-input me-3" name="autogas_status"
                                                                    type="radio" value="1" id="autogas_active"
                                                                    checked='checked' />
                                                                <!--end::Input-->
                                                                <!--begin::Label-->
                                                ...
                                                <div class="text-center pt-15">
                                                    <input type="hidden" id="autogas_id" name="id">
                    ...
                    <div class="card-body py-4">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="">
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                {{-- {{ $autogas_list }} --}}
                                @foreach ($autogas_list as $key => $list)
                                    <tr>
                                        <td></td>
                                        <td>{{ $key + 1 }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin-deleteautogas') }}?id={{ base64_encode($list->id) }}"
                    ...
                    <script>
                        function dataEdit(id, weight, price, status, image) {
                            ...
                            $('#autogas_id').val(id)
                            $('#add-autogas').text('Update autogas Details')
                            if (status == '1') {
                                // $('#status').val(id)
                                $('#autogas_active').attr('checked', true)
                            } else {
                                $('#autogas_deactive').attr('checked', true)
                            }

                            $('#autogasForm').attr('action', '{{ route('admin-updateautogas') }}');
                        }
                    </script>
