            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Dealers Request</li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-300 w-5px h-2px"></span>
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Dealership Request List</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card">
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header" id="kt_modal_add_category_header">
                                            <!--begin::Modal title-->
                                            <h2 class="fw-bolder" id="add-cylinder">Dealer Details</h2>
                                            <!--end::Modal title-->
                                            <!--begin::Close-->
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            <!--begin::DataShow-->
                                            <p style="display: inline-block;">DEALER NAME: -
                                            <h5 style="display: inline-block;" id="type"> </h5>
                                            </p>
                                            <p style="display: inline-block;">CONTACT PERSON: -
                                            ...
                                            <form action="{{ Route('admin-dealership_status') }}" method="post"
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">Dealer Name</th>
                    ...
                    <script>
                        function dataEdit(arr) {
                            // alert( arr.name );
                            $('#type').text(arr.dealer_name)
                            $('#weight').text(arr.contact_person)
